...
namespace DAL.Migrations
{
    ...
    [Migration("20251027121008_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.Setting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.ShipingPackging", b =>
                {
                    ...
                    b.ToTable("TbShipingPackginges");
                });

            modelBuilder.Entity("Domains.ShipingType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.UserReciver", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.UserSender", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Domains.VwCitiy", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domains.City", b =>
                {
                    b.HasOne("Domains.Country", "Country")
                        .WithMany("TbCities")
            ...
            modelBuilder.Entity("Domains.Shipment", b =>
                {
                    ...
                    b.HasOne("Domains.UserSender", "Sender")
                        ...
                        .IsRequired()
                        .HasConstraintName("FK_TbShipments_TbUserSebders");
            ...
            modelBuilder.Entity("Domains.UserSubscription", b =>
                {
                    b.HasOne("Domains.SubscriptionPackage", "Package")
